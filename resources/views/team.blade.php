...
<html>
    <head>
        ...
        <link rel="stylesheet" href="{{ URL::to('src/angular/css/faculty.css') }}"/>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="row pt-md">
                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 profile">
                                    <div class="img-box">
                                        <img src="{{ URL::to('src/images/users/user2-160x160.jpg') }}" style="width:200px;height: 200px;" class="img-responsive">
