                ...
                <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/login')); ?>">
                    ...
                    <div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?> has-feedback">
                        <div class="col-md-12">
                            ...
                            <input id="email" type="email" class="form-control" name="email" value="<?php echo e(old('email')); ?> "  style="border:1px 1px 1px 1px;border-color: gray;color:black;height: 35px;" placeholder="Email Address">
                    ...
                    <div class="form-group<?php echo e($errors->has('password') ? ' has-error' : ''); ?> has-feedback" style="margin-top: -20px;">
                        <div class="col-md-12">
